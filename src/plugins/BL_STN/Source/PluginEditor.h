...
class BLSTNAudioProcessorEditor  : public juce::AudioProcessorEditor, public juce::Timer
{
public:
    BLSTNAudioProcessorEditor (BLSTNAudioProcessor&);
    ~BLSTNAudioProcessorEditor() override;
...
private:
    ...
    BLSTNAudioProcessor& _audioProcessor;
    ...
    std::unique_ptr<STNSpectrum> _stnSpectrum = nullptr;
    
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BLSTNAudioProcessorEditor)
};
