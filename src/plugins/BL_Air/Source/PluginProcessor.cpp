...
BLAirAudioProcessor::BLAirAudioProcessor()
...
const juce::String
BLAirAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool
BLAirAudioProcessor::acceptsMidi() const
{
...
bool
BLAirAudioProcessor::producesMidi() const
{
...
bool
BLAirAudioProcessor::isMidiEffect() const
{
#if JucePlugin_IsMidiEffect
    return true;
#else
...
double
BLAirAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int
BLAirAudioProcessor::getNumPrograms()
{
...
int
BLAirAudioProcessor::getCurrentProgram()
{
    return 0;
}

void
BLAirAudioProcessor::setCurrentProgram(int index)
{
}

const juce::String
BLAirAudioProcessor::getProgramName(int index)
{
    return {};
}

void
BLAirAudioProcessor::changeProgramName(int index, const juce::String& newName)
{
}

void
BLAirAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
...
void
BLAirAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool
BLAirAudioProcessor::isBusesLayoutSupported(const BusesLayout& layouts) const
{
#if JucePlugin_IsMidiEffect
...
void
BLAirAudioProcessor::processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
bool BLAirAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* BLAirAudioProcessor::createEditor()
{
    return new BLAirAudioProcessorEditor (*this);
}

void BLAirAudioProcessor::getStateInformation(juce::MemoryBlock& destData)
{
...
void BLAirAudioProcessor::setStateInformation(const void* data, int sizeInBytes)
{
...
void
BLAirAudioProcessor::setSampleRateChangeListener(SampleRateChangeListener listener)
{
    _sampleRateChangeListener = listener;
}

bool
BLAirAudioProcessor::getBuffers(vector<float> *airBuffer,
...
void
BLAirAudioProcessor::setSplitFreq(float freq)
{  
...
createPluginFilter()
{
    return new BLAirAudioProcessor();
}
