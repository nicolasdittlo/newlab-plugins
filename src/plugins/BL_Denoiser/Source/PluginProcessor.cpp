...
BLDenoiserAudioProcessor::BLDenoiserAudioProcessor()
...
const juce::String
BLDenoiserAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool
BLDenoiserAudioProcessor::acceptsMidi() const
{
...
bool
BLDenoiserAudioProcessor::producesMidi() const
{
...
bool
BLDenoiserAudioProcessor::isMidiEffect() const
{
#if JucePlugin_IsMidiEffect
    return true;
#else
...
double
BLDenoiserAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int
BLDenoiserAudioProcessor::getNumPrograms()
{
...
int
BLDenoiserAudioProcessor::getCurrentProgram()
{
    return 0;
}

void
BLDenoiserAudioProcessor::setCurrentProgram(int index)
{
}

const juce::String
BLDenoiserAudioProcessor::getProgramName(int index)
{
    return {};
}

void
BLDenoiserAudioProcessor::changeProgramName(int index, const juce::String& newName)
{
}

void
BLDenoiserAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
...
void
BLDenoiserAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool
BLDenoiserAudioProcessor::isBusesLayoutSupported(const BusesLayout& layouts) const
{
#if JucePlugin_IsMidiEffect
...
void
BLDenoiserAudioProcessor::processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
bool BLDenoiserAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* BLDenoiserAudioProcessor::createEditor()
{
    return new BLDenoiserAudioProcessorEditor (*this);
}

void BLDenoiserAudioProcessor::getStateInformation(juce::MemoryBlock& destData)
{
...
void BLDenoiserAudioProcessor::setStateInformation(const void* data, int sizeInBytes)
{
...
void
BLDenoiserAudioProcessor::setSampleRateChangeListener(SampleRateChangeListener listener)
{
    _sampleRateChangeListener = listener;
}

bool
BLDenoiserAudioProcessor::getBuffers(vector<float> *signalBuffer,
...
int
BLDenoiserAudioProcessor::getOverlap(int quality)
{
    switch(quality)
    {
        case 0:
...
createPluginFilter()
{
    return new BLDenoiserAudioProcessor();
}
